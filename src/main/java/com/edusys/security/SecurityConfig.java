    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers(HttpMethod.GET, "/api/v1/courses/**", "/api/v1/batches/**", "/api/v1/semesters/**", "/api/v1/assignments/**", "/api/v1/exams/**", "/api/v1/grades/**").hasAnyRole("ADMIN", "TEACHER", "STUDENT", "PARENT", "REVIEWER")
                ...
                .requestMatchers("/api/v1/teachers/**", "/api/v1/courses/**", "/api/v1/batches/**", "/api/v1/semesters/**", "/api/v1/question-bank/**", "/api/v1/exams/**", "/api/v1/assignments/**", "/api/v1/grades/**").hasAnyRole("ADMIN", "TEACHER", "REVIEWER")
